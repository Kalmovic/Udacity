...
app = Flask(__name__)
#SQLite3 with multiple threrads...
...
def restaurantEdit(restaurant_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('editRestaurants.html', restaurant_id=restaurant_id, restaurant=editedRest)
...
def restaurantDelete(restaurant_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('deleterestaurant.html', d=restToDelete)
