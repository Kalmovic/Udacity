...
toy_story = media.Movie("Toy Story",
                        ...
                        "https://ingresso-a.akamaihd.net/img/cinema/cartaz/12264-cartaz.jpg",
...
les_miserables = media.Movie("Les Miserables",
                             "Set in France, Jean Valjean breaks parole after being released and runs from the grip of Inspector Javert. The story reaches resolution against the background of the June Rebellion.",
...
moulin_rouge = media.Movie("Moulin Rouge",
                           ...
                           "https://upload.wikimedia.org/wikipedia/pt/8/8b/Moulin_Rouge%21.jpg",
...
hunger_games = media.Movie("Hunger Games",
                           ...
                           "https://upload.wikimedia.org/wikipedia/pt/4/42/HungerGamesPoster.jpg",
                           "https://www.youtube.com/watch?v=mfmrPu43DF8")

phantom = media.Movie("The Phantom of the Opera",
                      ...
                      "https://upload.wikimedia.org/wikipedia/pt/6/65/O_Fantasma_da_Opera_poster.jpg",
                      "https://www.youtube.com/watch?v=N91AL8sAh9o")

silence = media.Movie("A Quiet Place",
...
star_wars = media.Movie("Star Wars",
                        ...
                        "https://upload.wikimedia.org/wikipedia/pt/thumb/f/f6/P%C3%B4ster_Star_Wars.jpg/250px-P%C3%B4ster_Star_Wars.jpg",
                        "https://www.youtube.com/watch?v=XHk5kCIiGoM")

movies = [les_miserables, avatar, toy_story, moulin_rouge, school_of_rock, star_wars, phantom, ratatouille, midnight_in_paris, hunger_games, silence, avengers]
